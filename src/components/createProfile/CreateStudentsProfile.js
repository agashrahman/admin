  ...
  return (
    ...
    <div className='d-flex'>
      ...
      <div className="tick row justify-content-center col-lg-12 ">
         ...
         <h3 className='h1get   '>Create Student Profile</h3>
         
         <h6 className='h6text text-secondary me='>Powered by KGiSL Microcollege Learners<a className='aget text-center mx-auto' href='learn more'>Learn More</a> </h6>
